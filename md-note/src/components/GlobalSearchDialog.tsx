...
export default function GlobalSearchDialog({
  ...
  const scoped = hasSearchScope(folderPath, recentFiles);
  ...
  const runSearch = useCallback(
    async (q: string) => {
      ...
      setSearching(true);
      try {
        const result = await searchWorkspace(folderPath, recentFiles, trimmed, {
          filenameOnly,
          useRegex,
        });
    ...
    [folderPath, recentFiles, scoped, filenameOnly, useRegex],
  );
    ...
    <div className="modal-backdrop" onClick={onClose}>
      ...
      >
        <div className="global-search-header">
          ...
          />
          {searching && <span className="global-search-status">{tr("globalSearch.searching")}</span>}
        </div>
