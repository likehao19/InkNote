...
const messages = {
  zh: {
    ...
    description: "墨笺 InkNote，一款面向 Windows 与 macOS 的本地优先、所见即所得 Markdown 编辑器。",
    skip: "跳到主要内容", brandZh: "墨笺", navFeatures: "功能", navScreens: "界面", navDownload: "下载",
    eyebrow: "本地优先 · Windows / macOS", heroTitle: "写 Markdown，<br />只看内容本身。", heroLead: "墨笺是一款所见即所得的桌面 Markdown 编辑器。没有割裂的双栏预览，点击即可编辑，移开焦点即呈现最终排版。",
    ...
    windowsMeta: "Windows 10/11 · x64 · 中文安装程序", macIntelMeta: "Intel 芯片 · x86_64 · DMG", macArmMeta: "Apple 芯片 · ARM64 · DMG",
    downloadWindows: "下载 Windows 版", downloadMacIntel: "下载 Mac Intel 版", downloadMacArm: "下载 Mac ARM 版", otherPackages: "需要历史版本？", allReleases: "查看全部 Releases ↗",
    footerText: "为专注的 Markdown 写作而设计。", issues: "问题反馈"
  },
  en: {
    title: "InkNote — A focused Markdown editor",
    description: "InkNote is a local-first WYSIWYG Markdown editor for Windows and macOS.",
    skip: "Skip to main content", brandZh: "", navFeatures: "Features", navScreens: "Interface", navDownload: "Download",
    eyebrow: "Local first · Windows / macOS", heroTitle: "Write Markdown.<br />See only the content.", heroLead: "InkNote is a WYSIWYG desktop Markdown editor. There is no disconnected split preview: click to edit, then return to the finished typeset view when focus moves away.",
    ...
    windowsMeta: "Windows 10/11 · x64 · Chinese installer", macIntelMeta: "Intel · x86_64 · DMG", macArmMeta: "Apple silicon · ARM64 · DMG",
    downloadWindows: "Download for Windows", downloadMacIntel: "Download for Mac Intel", downloadMacArm: "Download for Mac ARM", otherPackages: "Need an older version?", allReleases: "View all Releases ↗",
